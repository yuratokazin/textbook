...
| 0.1    | Цели и структура курса. Обзор профессии Frontend-разработчика. | 2               | 2         | 0         |  *Открытый урок 15.09.2025* |
...
| 2.1    | Основы синтаксиса. Селекторы, комбинаторы, наследование.     | 6               | 2         | 4         | *Открытый урок 13.10.2025* |
...
| 3.3    | Браузерные инструменты разработчика (DevTools).            | 4               | 1         | 3         |     *Открытый урок 24.11.2025* |
